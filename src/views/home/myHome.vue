  ...
  <div class="own-space">
    <Card>
      ...
      <Form ref="userForm" :model="userForm" :label-width="90" label-position="left">
        ...
        <Row :gutter="16">
          ...
          <Col :span="12">
            <FormItem label="所属班级" prop="departmentTitle">
    ...
    <Card>
      <Row :gutter="16">
        ...
        <Col span="12">
          <Divider
            >个人门户设置 <Button @click="addMenuFx" type="primary">保存更改</Button></Divider
          >
          <Row :gutter="16">
...
<script>
import { getMyDoorList, setMyDoorList, userInfoEdit } from './api.js'
