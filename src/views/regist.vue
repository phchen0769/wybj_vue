    ...
    <Row justify="center" align="middle" @keydown.enter.native="submitRegist" style="height: 100%">
      <div class="loginUp">
        <div class="loginLeft">
          ...
          <span class="title">五育并举评价系统</span>
        </div>
      </div>
      <div class="loginMiddle">
        <div class="login-background">
          ...
          <div class="loginRight">
                ...
                <FormItem prop="code">
                  ...
                  >
                    ...
                    <Col span="8">
                      <div
                        class="code-image"
                        style="position: relative; font-size: 12px; width: 100%"
                      >
            ...
            <p class="loginBottom">ART YOUR DREAM</p>
      ...
      <div class="loginDown">
        ...
        <p>
          ...
          <a target="_blank" href="https://beian.miit.gov.cn" style="color: #848585"
            >ICP备案 浙ICP备XXXXXXXX号</a
          >
          <a
            target="_blank"
            href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=XXXXXXXXXXXXXX号"
          >
...
<script>
import { regist, drawCodeImage, initCaptcha } from '@/api/index'
