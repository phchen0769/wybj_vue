    ...
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
        ...
        <FormItem label="数学成绩" prop="achievementTwo">
          <InputNumber
            v-model="form.achievementTwo"
            min="0"
            max="100"
            style="width: 570px"
          ></InputNumber>
        </FormItem>
        <FormItem label="英语成绩" prop="achievementThree">
          <InputNumber
            v-model="form.achievementThree"
            min="0"
            max="100"
            style="width: 570px"
          ></InputNumber>
...
<script>
import { editStudentEvaluate, editYuShuWai } from './api.js'
export default {
  name: 'edit',
  components: {},
  props: {
