<template>
  <div class="search">
      ...
      <Form ref="searchForm" :model="searchForm" inline :label-width="100">
        <Row class="operation">
          ...
          <Button
            ...
            >生成</Button
          >
          <Button @click="clear" size="small" type="error" ghost shape="circle" icon="md-trash"
            >清空</Button
          >
        </Row>
      </Form>
    ...
    <Modal title="生成代码" v-model="codeModal" :width="1000" styles="top:30px">
      ...
      <div slot="footer">
        <Button
          v-clipboard:copy="createCodeContent"
...
<script>
import { generateTable, getEntityData } from './api.js'
export default {
  name: 'vue-code',
  data() {
    return {
