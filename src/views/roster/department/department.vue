<template>
  <div class="search">
      ...
      <Row :gutter="16">
        ...
        <Col span="16">
          <Form ref="form" :model="form" :label-width="100" :rules="formValidate">
                ...
                <FormItem label="上级部门" prop="parentTitle">
                  <div style="display: flex">
                    ...
                    <Poptip
                      ...
                      width="250"
                    >
                      <Button icon="md-list">选择班级</Button>
            ...
            <Row :gutter="16">
              <Col span="12">
                <FormItem label="班级领导" prop="mainHeader">
                  <Select
                    :loading="userLoading"
                    not-found-text="该班级暂无用户数据"
              ...
              <Col span="12">
                <FormItem label="班级组长" prop="viceHeader">
                  <Select
                    :loading="userLoading"
                    not-found-text="该班级暂无用户数据"
    ...
    <Divider dashed>班级下用户列表</Divider>
    <Card>
      <Row>
        <Table
          :loading="userLoading"
  ...
  methods: {
    ...
    submitEdit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          if (!this.form.id) {
            this.$Message.warning('请先点击选择要修改的班级')
            return
          }
