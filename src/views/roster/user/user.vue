      ...
      <Row>
        <Form ref="searchForm" :model="searchForm" inline :label-width="40">
          ...
          <Form-item style="position: fixed; right: 50px; top: 130px">
            ...
            <Button
              type="warning"
              @click="usingTutorialsModal = true"
              class="showFilterPanelFlag"
              ...
              h(
                'Button',
                {
                  props: {
                    ...
                    shape: 'circle',
                    disabled: !(
                      that.$route.meta.permTypes && that.$route.meta.permTypes.includes('edit')
                    )
                  },
                  style: {
                    marginRight: '5px'
              ...
              h(
                'Button',
                {
                  props: {
                    ...
                    shape: 'circle',
                    disabled: !(
                      that.$route.meta.permTypes && that.$route.meta.permTypes.includes('delete')
                    )
                  },
                  on: {
                    click: () => {
