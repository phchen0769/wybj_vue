...
<div class="search">
    ...
    <Card v-show="currView=='index'">
        <Alert type="success" show-icon banner>温馨提示：教师模块的学历使用Tag标签渲染，工资大于小于5000条件渲染，在职状态为Switch组件，签名为图片组件，个人简历为附件组件！</Alert>
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="education">
                        <dict dict="education" v-model="searchForm.education" transfer clearable placeholder="学历" style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="graduated">
                        <Input type="text" v-model="searchForm.graduated" placeholder="毕业院校" clearable style="width: 120px" />
                    </Form-item>
