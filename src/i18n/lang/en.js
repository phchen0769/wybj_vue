export default {
  ...
  guide: {
    ...
    endingTitle: 'Thank you for using',
    endingDesc:
      'And that is all, go ahead and start using the system. If you have any questions, please contact the author. Thank you for your support.'
  },
  profile: {
    muted:
