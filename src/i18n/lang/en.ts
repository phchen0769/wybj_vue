export default {
  ...
  guide: {
    ...
    endingTitle: 'Ending',
    endingDesc: 'Click "Done" to continue using the system. Thank you.',
    done: 'Done'
  },
  profile: {
    muted:
      "A web application for video consultations between doctors and patients, where doctors can create medical records based on the patient's symptoms.",
    introduce: 'Introduce',
